...
// Exercise 11
describe("moreEqualThanSeven", () => {
  test("moreEqualThanSeven should be declared", () => {
    expect(typeof moreEqualThanSeven).toEqual("number");
  });

  test("moreEqualThanSeven return first number that is more or equal 7", () => {
    expect(moreEqualThanSeven).toEqual(7);
  });
});
